...
If the tokens-type is fpinyin, ppinyin or phone+ppinyin, you MUST provide the original keyword (starting with @) and the original keyword CAN NOT contain spaces, please replace spaces with underscores (_).
