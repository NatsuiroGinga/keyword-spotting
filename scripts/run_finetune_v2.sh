#!/bin/bash
# KWS Fine-tuning Script V2 for "你好真真" wake word
# Improved version with negative samples training
...
echo "Starting KWS fine-tuning V2 (with negative samples)..."
